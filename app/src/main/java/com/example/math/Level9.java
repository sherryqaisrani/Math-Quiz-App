...
//                    alert();
                    if (score < 30)
                    {
                        Toast.makeText(Level9.this,"Passing Marks 30",Toast.LENGTH_LONG).show();
                        second = 10;
                        stopTimer = true;
                        score = 0;
                    ...
                    {
                        Toast.makeText(Level9.this,"Congrate You have passed this level",Toast.LENGTH_LONG).show();
                        stopTimer = true;
