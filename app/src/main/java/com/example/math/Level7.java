...
//                    alert();
                    if (score < 30)
                    {
                        Toast.makeText(Level7.this,"Passing Marks 30",Toast.LENGTH_LONG).show();
                        second = 10;
                        stopTimer = true;
                        score = 0;
                    ...
                    {
                        Toast.makeText(Level7.this,"Congrate You have passed this level",Toast.LENGTH_LONG).show();
                        stopTimer = true;
