...
//                    alert();
                    if (score < 30)
                    {
                        Toast.makeText(Level10.this,"Passing Marks 30",Toast.LENGTH_LONG).show();
                        second = 10;
                        stopTimer = true;
                        score = 0;
                    ...
                    {
                        Toast.makeText(Level10.this,"Congrate You have passed this level",Toast.LENGTH_LONG).show();
                        stopTimer = true;
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
//                                startActivity(new Intent(Level10.this,.class));
                                finish();
                            }
                        });
                    }
